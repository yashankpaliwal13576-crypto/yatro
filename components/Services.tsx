  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-16 text-center md:text-left">
        ...
        <p className="text-gray-400 max-w-2xl ml-6">Comprehensive travel solutions powered by intelligence, ensuring every mile of your journey is managed with precision.</p>
      </div>
        ...
        {services.map((service, i) => (
          <div key={i} className="group relative overflow-hidden rounded-[2.5rem] glass-card border border-white/5 transition-all hover:border-purple-500/50 flex flex-col hover:shadow-[0_0_40px_rgba(168,85,247,0.1)]">
            <div className="h-56 overflow-hidden relative">
              <img src={service.img} alt={service.title} className="w-full h-full object-cover opacity-40 group-hover:opacity-60 transition-all duration-700 group-hover:scale-110" />
            ...
            <div className="p-8 flex-1 flex flex-col relative">
              ...
              <button 
                ...
                className="mt-auto self-start text-[10px] font-black text-purple-400 border border-purple-500/30 px-5 py-2.5 rounded-full hover:bg-purple-500/10 transition-all flex items-center gap-2 uppercase tracking-widest shadow-lg"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="glass-card p-12 rounded-[3rem] border-l-8 border-blue-600 flex flex-col justify-between hover:shadow-[0_0_50px_rgba(37,99,235,0.15)] transition-all">
          ...
          <button 
            ...
            className="self-start text-[10px] font-black text-blue-400 border border-blue-500/30 px-6 py-3 rounded-2xl hover:bg-blue-500/10 transition-all flex items-center gap-2 uppercase tracking-widest"
          >
        ...
        <div className="glass-card p-12 rounded-[3rem] border-l-8 border-purple-600 flex flex-col justify-between hover:shadow-[0_0_50px_rgba(147,51,234,0.15)] transition-all">
          ...
          <button 
            ...
            className="self-start text-[10px] font-black text-purple-400 border border-purple-500/30 px-6 py-3 rounded-2xl hover:bg-purple-500/10 transition-all flex items-center gap-2 uppercase tracking-widest"
          >
